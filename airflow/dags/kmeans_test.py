...
loaded_model = joblib.load('/home/airflow/dags/kmeans_model.joblib')
...
recomms.to_csv("/home/airflow/dags/kmeans_results.csv", index = False)
...
path = f"KMeans/" + "kmeans_results"
blob = gcs_bucket.blob(path)
blob.upload_from_filename("/home/airflow/dags/kmeans_results.csv")
