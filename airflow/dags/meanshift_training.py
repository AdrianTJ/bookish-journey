...
base = pd.read_csv("/home/airflow/dags/000000000000.csv")
...
# This function converts a list of ingredients into a dictionary, note: every ingredient gets a 1.
